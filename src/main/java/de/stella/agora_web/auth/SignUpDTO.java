...
/**
 * Clase que representa un objeto de transferencia de datos para realizar el registro de un usuario.
 * Contiene los campos necesarios para registrar un usuario, que son el nombre de usuario y la contraseña.
 * Los getters y setters permiten la configuración y obtención de estos valores.
 */
@Getter
@Setter
public class SignUpDTO { 
    ...
    /**
     * Constructor sin argumentos. Se utiliza principalmente para la serialización de objetos.
     */
    public SignUpDTO() { 
    ...
    /**
     * Constructor que inicializa los campos username y password con los valores pasados como argumentos.
     * 
