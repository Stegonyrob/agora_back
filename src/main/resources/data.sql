...
INSERT INTO texts (id, title, description, image, name_image) VALUES
  ...
  (9, 'Escuela de Familias', 'Programa de formación y apoyo dirigido a padres y madres. Se ofrecen herramientas, estrategias y recursos para afrontar los retos de la crianza, mejorar la comunicación familiar y promover un desarrollo saludable de los hijos.', '../../../public/images/img/niñoPuzzle.jpg', 'escuelaPadres'),
